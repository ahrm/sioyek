...
CommandManager::CommandManager() {
	...
	commands.push_back({ "next_item",			false,	false,	false,	false, {}});
	commands.push_back({ "previous_item", false, false , false, false, {}});
	commands.push_back({ "set_mark", false, true , false, false, {}});
	commands.push_back({ "goto_mark", false, true , false, true, {'`', '\'', '/'}});
	commands.push_back({ "goto_page_with_page_number", true, false , false, true, {}});
	commands.push_back({ "search", true, false , false, true, {}});
	...
	commands.push_back({ "goto_highlight", false, false , false, true, {}});
	commands.push_back({ "goto_bookmark", false, false , false, true, {}});
	commands.push_back({ "goto_bookmark_g", false, false , false, true, {}});
	commands.push_back({ "goto_highlight_g", false, false , false, true, {}});
	commands.push_back({ "goto_highlight_ranged", false, false , false, true, {}});
	...
	commands.push_back({ "goto_link", false, false , false, true, {}});
	commands.push_back({ "goto_portal", false, false , false, true, {}});
	commands.push_back({ "edit_link", false, false , false, false, {}});
	commands.push_back({ "edit_portal", false, false , false, true, {}});
	commands.push_back({ "open_prev_doc", false, false , false, true, {}});
	commands.push_back({ "open_document_embedded", false, false , false, true, {}});
	commands.push_back({ "open_document_embedded_from_current_path", false, false , false, true, {}});
	...
	commands.push_back({ "next_chapter", false, false , false, false, {}});
	commands.push_back({ "prev_chapter", false, false , false, false, {}});
