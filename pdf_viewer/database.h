...
bool insert_link(sqlite3* db, std::wstring src_document_path, std::wstring dst_document_path, float dst_offset_y, float dst_offset_x, float dst_zoom_level, float src_offset_y);
