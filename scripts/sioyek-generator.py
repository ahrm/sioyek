...
sioyek_commands = {
    ...
    "library_add_current_document": [ False, False , False, False],
    "library_add_current_document_to_collection": [ False, False , False, False],
    "library_create_collection": [ False, False , False, False],
    "library_import_file": [ False, False , False, False],
    "library_import_folder": [ False, False , False, False],
    "library_import_folder_recursive": [ False, False , False, False],
    "library_import_folder_recursive_to_collection": [ False, False , False, False],
    "library_import_folder_to_collection": [ False, False , False, False],
    "library_remove_current_document": [ False, False , False, False],
    "library_remove_current_document_from_collection": [ False, False , False, False],
    "library_open": [ False, False , False, False],
    "library_open_collection": [ False, False , False, False],
    "library_show_current_document_info": [ False, False , False, False],
    ...
    "workspace_delete": [ False, False, False, False],
    "workspace_open": [ False, False, False, False],
    "workspace_save_current": [ False, False, False, False],
    "workspace_update_current": [ False, False, False, False],
